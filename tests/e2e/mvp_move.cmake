...
if(NOT source_contents MATCHES
   "return calculate_total_codesplit_implementation\\(base, surcharge\\)")
    message(FATAL_ERROR "source function was not converted to a forwarding wrapper")
endif()
file(READ "${target_file}" target_contents)
if(NOT target_contents MATCHES "int calculate_total_codesplit_implementation")
    message(FATAL_ERROR "extracted implementation was not created")
endif()
