...
Команда выводит путь, размер файла в байтах, количество строк и признак превышения порога
100 КиБ. Семантический анализ C++ будет добавлен на следующем этапе.
