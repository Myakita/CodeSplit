...
[[nodiscard]] std::string format_text_move_dry_run(const planning::MoveDryRun& dry_run);
[[nodiscard]] std::string format_text_move_apply(const planning::MoveApplyResult& result);
